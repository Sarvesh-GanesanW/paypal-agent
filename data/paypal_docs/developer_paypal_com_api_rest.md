...
You can try our REST APIs in Postman without a PayPal Developer account. Learn more in our
Postman guide
.
Explore our REST API descriptions, generate code for your API clients, and import OpenAPI documents into compatible
third-party tools
.
Important:
You’ll need a
...
Apps & Credentials
.
New accounts come with a
Default Application
in the
REST API apps
section. To create a new project, select
Create App
.
...
"access_token"
:
"A21AAFEpH4PsADK7qSS7pSRsgzfENtu-Q1ysgEDVDESseMHBYXVJYE8ovjj68elIDy8nF26AwPhfXTIeWAZHSLIsQkSYz9ifg"
,
4
"token_type"
:
...
Make API calls
When you make API calls, replace
ACCESS-TOKEN
with your access token in the authorization header:
...
>
Sandbox Accounts
. You can create more sandbox accounts by selecting
Create account
.
...
Select
View/Edit Account
to see mock information such as the account email and system-generated password.
Go to
sandbox.paypal.com/signin
and sign in with the personal sandbox credentials. In a separate browser, sign in with the business sandbox credentials.
